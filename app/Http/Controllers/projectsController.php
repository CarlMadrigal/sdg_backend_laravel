...
class projectsController extends Controller
{
    ...
    public function index(){
        ...
        foreach ($projects as $project) {
            $container[] = [
                ...
                'tags' => [
                    'name' => $project->tag ? $this->splitArray($project->tag->name) : [],
                    'image' => $project->tag ? $this->splitArray($project->tag->image) : [],
                ]
                /*'tags' => [
                ...
                'subject' => [
                    'initiator' => $project->subject ? $this->splitArray($project->subject->initiator) : [],
                    'leader' => $project->subject ? $this->splitArray($project->subject->leader) : [],
                    'members' => $project->subject ? $this->splitArray($project->subject->members) : [],
                ]
                /*'subject' => [
                ...
                'environment' => [
                    'nature' => $project->environment ? $this->splitArray($project->environment->nature) : [],
                    'industry' => $project->environment ? $this->splitArray($project->environment->industry) : [],
                    'government' => $project->environment ? $this->splitArray($project->environment->government) : [],
                ]
                ...
                'resources' => [
                    'human' => $project->resource ? $this->splitArray($project->resource->human) : [],
                    'financial' => $project->resource ? $this->splitArray($project->resource->financial) : [],
                    'technical' => $project->resource ? $this->splitArray($project->resource->technical) : [],
                ]
                /*'resources' => [
                ...
                'mechanism' => [
                    'planning' => $project->mechanism ? $project->mechanism->planning : null,
                    'design' => $project->mechanism ? $project->mechanism->design : null,
                    'installation' => $project->mechanism ? $project->mechanism->installation : null,
                    'testing' => $project->mechanism ? $project->mechanism->testing : null,
                    'monitoring' => $project->mechanism ? $project->mechanism->monitoring : null,
                ]
                /*'mechanism' => [
    ...
    public function upload(Request $request)
    {
        ...
        if ($validator->fails()) {
            $message = $validator->messages()->first();  // Get the first error message
            $data = [
                "status" => 422,
                "message" => $message
            ];
